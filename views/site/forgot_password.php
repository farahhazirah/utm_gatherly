    ...
    <div class="container">
        ...
        <div id="loginForm" class="form-content">
            ...
            <form action="<?php echo BASE_URL; ?>index.php?r=site/signup" method="POST">
                ...
                <button type="submit" style="background: linear-gradient(90deg, #64b5f6, #90caf9);">Reset</button>
            </form>
        </div>

        <!-- Toggle Button for Switching to Signup Page -->
        <p>Remember It ? <a href="<?php echo BASE_URL; ?>index.php?r=site/login">Sign In</a></p>
