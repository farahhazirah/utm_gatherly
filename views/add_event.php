<style>
    ...
    .custom-save-btn {
    background-color: #8c2f39 !important; /* Custom button background color */
  ...
  .custom-save-btn:hover {
    background-color: #a0303e !important; /* Hover effect color */
  }
</style>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="eventForm" action="controller/CalendarController" method="POST"> <!-- Wrap inputs in a form -->
